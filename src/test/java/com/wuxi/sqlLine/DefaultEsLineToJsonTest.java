...
public class DefaultEsLineToJsonTest {
    ...
    private LineToJson lineToJson = new DefaultEsLineToJson();

    @Test
    public void lineToString() {
        System.out.println(lineToJson.lineToString(esLine2, new ArrayList<>()));
    }
}
